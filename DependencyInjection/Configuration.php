                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('comment')->isRequired()->addDefaultsIfNotSet()
                            ->children()
                                ->arrayNode('create')->isRequired()->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('type')->defaultValue('fos_comment.comment')->end()
                                        ->scalarNode('name')->defaultValue('fos_comment_comment_create')->end()
                                    ->end()
                                ->end()
                                ->arrayNode('reply')->isRequired()->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('type')->defaultValue('fos_comment.comment')->end()
                                        ->scalarNode('name')->defaultValue('fos_comment_comment_reply')->end()
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
