    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder->root('fos_comment')
            ->children()
                ...
                ->booleanNode('vote_unique')->defaultFalse()->end()
                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('vote')->addDefaultsIfNotSet()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('delete_vote')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue(LegacyFormHelper::getType('FOS\CommentBundle\Form\DeleteVoteType'))->end()
                                ->scalarNode('name')->defaultValue('fos_comment_delete_vote')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                    ...
                    ->children()
                        ...
                        ->arrayNode('form_factory')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('delete_vote')->cannotBeEmpty()->defaultValue('fos_comment.form_factory.delete_vote.default')->end()
                            ->end()
                        ->end()
