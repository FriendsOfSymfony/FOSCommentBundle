                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('vote')->addDefaultsIfNotSet()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('flag')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue(LegacyFormHelper::getType('FOS\CommentBundle\Form\FlagType'))->end()
                                ->scalarNode('name')->defaultValue('fos_comment_flag')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('acl_roles')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('flag')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('create')->cannotBeEmpty()->defaultValue('IS_AUTHENTICATED_ANONYMOUSLY')->end()
                                ->scalarNode('view')->cannotBeEmpty()->defaultValue('ROLE_ADMIN')->end()
                                ->scalarNode('edit')->cannotBeEmpty()->defaultValue('ROLE_ADMIN')->end()
                                ->scalarNode('delete')->cannotBeEmpty()->defaultValue('ROLE_ADMIN')->end()
                            ->end()
                        ->end()
                    ...
                    ->children()
                        ->arrayNode('manager')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('flag')->cannotBeEmpty()->defaultValue('fos_comment.manager.flag.default')->end()
                            ->end()
                        ->end()
                        ->arrayNode('acl')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('flag')->cannotBeEmpty()->defaultValue('fos_comment.acl.flag.security')->end()
                            ->end()
                        ->end()
                        ->arrayNode('form_factory')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('flag')->cannotBeEmpty()->defaultValue('fos_comment.form_factory.flag.default')->end()
                            ->end()
                        ->end()
